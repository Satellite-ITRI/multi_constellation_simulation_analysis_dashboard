...
export const useDownloadResult = () => {
  ...
  const downloadResult = async () => {
    ...
    try {
      // 直接建立下載連結指向 public 目錄下的 PDF 檔案
      const link = document.createElement('a');
      link.href = '/constellation_system_simulation_result.pdf';
      link.download = 'constellation_system_simulation_result.pdf';
...
export const tmp_useDownloadResult = () => {
  const [isDownloading, setIsDownloading] = useState(false);
