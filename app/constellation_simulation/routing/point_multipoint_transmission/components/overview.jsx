...
import { singleToMultiConfig } from '@/app/constellation_simulation/input_format';
import { useDownloadResult } from '@/app/constellation_simulation/routing/point_multipoint_transmission/service';
import { ToastProvider } from '@/components/ui/toast';
import { useState } from 'react';

export default function SingleToMultiPage() {
  const [formData, setFormData] = useState(singleToMultiConfig.defaultValues);
