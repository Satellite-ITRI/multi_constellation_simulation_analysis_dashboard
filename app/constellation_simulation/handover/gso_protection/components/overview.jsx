...
import { gsoProtectionConfig } from '@/app/constellation_simulation/input_format';
import { useDownloadResult } from '@/app/constellation_simulation/handover/gso_protection/service';
import { ToastProvider } from '@/components/ui/toast';
import { useState } from 'react';

export default function GSOProtectionPage() {
  const [formData, setFormData] = useState(gsoProtectionConfig.defaultValues);
