...
import { singlebeamHandoverConfig } from '@/app/constellation_simulation/input_format';
import { useDownloadResult } from '@/app/constellation_simulation/handover/singlebeam/service';
import { ToastProvider } from '@/components/ui/toast';
import { useState } from 'react';

export default function SinglebeamHandoverPage() {
  const [formData, setFormData] = useState(
    singlebeamHandoverConfig.defaultValues
  );
        ...
        <div className="mx-auto min-h-screen bg-gray-50 px-40 pt-32">
          <div className="mx-auto max-w-4xl">
            ...
            <SimulationForm
              ...
              config={singlebeamHandoverConfig}
            />
          </div>
        </div>
      </ToastProvider>
