...
import { dynamicRepairConfig } from '@/app/constellation_simulation/input_format';
import { useDownloadResult } from '@/app/constellation_simulation/isl/dynamic_recovery_reconstruction/service';
import { ToastProvider } from '@/components/ui/toast';
import { useState } from 'react';

export default function DynamicRepairPage() {
  const [formData, setFormData] = useState(dynamicRepairConfig.defaultValues);
