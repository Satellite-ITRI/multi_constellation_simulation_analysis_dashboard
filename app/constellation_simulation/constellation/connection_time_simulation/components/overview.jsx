...
import { connectionTimeConfig } from '@/app/constellation_simulation/input_format';
import { useDownloadResult } from '@/app/constellation_simulation/constellation/connection_time_simulation/service';
import { ToastProvider } from '@/components/ui/toast';
import { useState } from 'react';

export default function ConnectionTimePage() {
  const [formData, setFormData] = useState(connectionTimeConfig.defaultValues);
